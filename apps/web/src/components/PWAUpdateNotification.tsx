...
export function PWAUpdateNotification() {
  ...
  return (
    <div className="fixed top-4 left-4 right-4 z-50 bg-ring text-white p-4 rounded-lg shadow-lg flex items-center justify-between animate-in slide-in-from-top duration-300">
